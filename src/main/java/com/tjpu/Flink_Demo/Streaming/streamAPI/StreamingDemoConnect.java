...
public class StreamingDemoConnect {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<String> text2_str = text2.map(new myMap6());

        ConnectedStreams<Long, String> connectStream = text1.connect(text2_str);

        SingleOutputStreamOperator<Object> result = connectStream.map(new myMap6_connect());
...
class myMap6 implements MapFunction<Long, String> {
    @Override
...
class myMap6_connect implements CoMapFunction<Long, String, Object> {
    @Override
