package com.tjpu.SpringBoot.HotLoader.classloader;


import com.tjpu.SpringBoot.HotLoader.Application;
...
//        com.luban.className.class
    ...
    public static void main(String[] args)  throws Exception{
        ...
        /**
         * 由于无法实现热启动是因为，这个文件的路径带有中文汉字，无法找到这个test.class
         * 默认使用了aapp类加载器实现
         *
         * 重新放到全英文路径可以实现热部署
         */
...
//        Application.run(MyClassLoader.class);
        ...
        while (true){
            ...
            Class<?> aClass = myClassLoader.loadClass("com.tjpu.SpringBoot.HotLoader.Test");
